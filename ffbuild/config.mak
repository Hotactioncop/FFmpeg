...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/araz/Handbrake/build/contrib/ --disable-shared --enable-static --enable-gpl --disable-doc --disable-programs --disable-avdevice --disable-muxers --disable-network --disable-filters --disable-hwaccels --disable-vdpau --disable-postproc --disable-encoders --enable-libmp3lame --enable-encoder=aac --enable-encoder=ac3 --enable-encoder=eac3 --enable-encoder=flac --enable-encoder=mpeg2video --enable-encoder=mpeg4 --enable-encoder=libmp3lame --enable-libopus --enable-encoder=libopus --enable-libspeex --disable-encoder=libspeex --enable-decoder=libspeex --enable-encoder=truehd --enable-libvpx --disable-decoder='libvpx_*' --enable-encoder=libvpx_vp8 --enable-encoder=libvpx_vp9 --enable-encoder=ffv1 --enable-demuxer=av1 --enable-demuxer=obu --enable-decoder=av1 --enable-libdav1d --enable-decoder=libdav1d --enable-libzimg --enable-filter=format --enable-filter=crop --enable-filter=scale --enable-filter=zscale --enable-filter=pad --enable-filter=transpose --enable-filter=hflip --enable-filter=vflip --enable-filter=yadif --enable-filter=bwdif --enable-filter=deblock --enable-filter=tonemap --enable-filter=monochrome --enable-filter=hwdownload --enable-filter=hwmap --enable-filter=hwupload --cc=/usr/bin/gcc --enable-vaapi --disable-xlib --enable-muxer=matroska --enable-muxer=webm --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=psp --enable-muxer=ipod --extra-libs='-lm -lstdc++' --enable-debug --enable-libvpl --enable-filter=vpp_qsv --enable-amf --enable-encoder=h264_amf --enable-encoder=hevc_amf --enable-encoder=av1_amf --enable-ffnvcodec --enable-encoder=h264_nvenc --enable-encoder=hevc_nvenc --enable-encoder=av1_nvenc
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS=-I/home/araz/Handbrake/build/contrib/include -DDEBUG -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -DZLIB_CONST
CFLAGS=-I/home/araz/Handbrake/build/contrib/include -mfpmath=sse -msse2 -fstack-protector-strong -D_FORTIFY_SOURCE=2 -g3 -DDEBUG   -std=c17 -fomit-frame-pointer -fPIC -I/home/araz/Handbrake/build/contrib//include -pthread  -pthread -I/home/araz/Handbrake/build/contrib/include -I/usr/include/libdrm -I/home/araz/Handbrake/build/contrib/lib/pkgconfig/../../include -I/home/araz/Handbrake/build/contrib/lib/pkgconfig/../../include/vpl -DMFX_DEPRECATED_OFF -I/usr/include/opus -I/usr/include/opus    -I/home/araz/Handbrake/build/contrib/include      -I/usr/include/libdrm   -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=-I/home/araz/Handbrake/build/contrib/include -mfpmath=sse -msse2 -fstack-protector-strong -D_FORTIFY_SOURCE=2 -g3 -DDEBUG  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=   -fPIC -g
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=-L/home/araz/Handbrake/build/contrib/lib -fstack-protector-strong -DDEBUG  -Wl,--as-needed -Wl,-z,noexecstack -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avfilter=-pthread -lm -latomic -L/home/araz/Handbrake/build/contrib/lib -lzimg -L/home/araz/Handbrake/build/contrib/lib/pkgconfig/../ -lvpl -ldl -lstdc++
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-postproc=-lm -latomic
EXTRALIBS-avformat=-lm -latomic -lbz2 -lz
EXTRALIBS-avcodec=-lvpx -lm -lvpx -lm -pthread -lm -latomic -llzma -L/home/araz/Handbrake/build/contrib/lib -ldav1d -pthread -ldl -lspeex -lmp3lame -lm -lopus -lz
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-pthread -lva-drm -lva -lm -ldrm -L/home/araz/Handbrake/build/contrib/lib/pkgconfig/../ -lvpl -ldl -lstdc++ -lva -latomic
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
