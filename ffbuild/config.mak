...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-amf --extra-cflags=-I./../../../../../AMF/ --target-os=win64 --arch=x86_64 --toolchain=msvc --disable-doc --disable-ffplay --disable-ffprobe --enable-debug=3 --disable-optimizations
prefix=/usr/local
...
CC_IDENT=Microsoft (R) C/C++ Optimizing Compiler Version 19.29.30154 for x64
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=cl.exe
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DWIN32_LEAN_AND_MEAN -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0600 -I$(SRC_PATH)/compat/atomics/win32
CFLAGS= -nologo -I./../../../../../AMF/ /std:c17 -g3 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -O1   -utf-8
CXXFLAGS=  -D__STDC_CONSTANT_MACROS /std:c++11
OBJCCFLAGS= -nologo 
ASFLAGS= -nologo -I./../../../../../AMF/ -g3
